// const DeletePopup = ({ index, delete } : { index: number; delete: boolean }) => {
//     return (
//         <>
...
//                             </svg>
//                             <h2 className="text-xl font-bold py-4">Delete Article</h2>
//                         </div>
//                         <div className="p-3 mt-2 text-center space-x-4 md:block">
//                             <button className="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-gray-100">
//                                 No
//                             </button>
//                             <button className="mb-2 md:mb-0 bg-red-500 border border-red-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-red-600">Yes</button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
